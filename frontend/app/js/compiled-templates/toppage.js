...
templates['homepage'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<link rel=\"stylesheet\" href=\"assets/styles/toppage/homepage.css\" >\n"
    ...
    + ((stack1 = (helpers.loadModule || (depth0 && depth0.loadModule) || helpers.helperMissing).call(depth0,"homepageBindings",{"name":"loadModule","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
